...
```java
- C:\Users\SoporteTI\IdeaProjects\CodeLab\LRBA-MX-JSPRK-EXAMPLE-V00
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobExampleBuilder.java**: Indicates the sources and targets the generated application
